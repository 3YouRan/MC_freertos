...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, DC_Pin|RES_Pin|SDA_Pin|SCL_Pin
                          |LASER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, DIR2_Pin|DIR1_Pin|LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DIR2_Pin EN2_Pin */
  GPIO_InitStruct.Pin = DIR2_Pin|EN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
