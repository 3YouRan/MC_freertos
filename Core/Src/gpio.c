...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, AIN21_Pin|AIN22_Pin|AIN11_Pin|AIN12_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, CMD_Pin|CS_Pin|CLK_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, AIN31_Pin|AIN34_Pin|LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(AIN41_GPIO_Port, AIN41_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : AIN21_Pin AIN22_Pin AIN12_Pin */
  GPIO_InitStruct.Pin = AIN21_Pin|AIN22_Pin|AIN12_Pin;
  ...
  /*Configure GPIO pins : AIN31_Pin AIN34_Pin */
  GPIO_InitStruct.Pin = AIN31_Pin|AIN34_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : AIN41_Pin */
  GPIO_InitStruct.Pin = AIN41_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(AIN41_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : AIN11_Pin */
  GPIO_InitStruct.Pin = AIN11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(AIN11_GPIO_Port, &GPIO_InitStruct);
