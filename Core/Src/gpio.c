...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, CMD_Pin|CS_Pin|CLK_Pin|LED_R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DAT_Pin L2_Pin */
  GPIO_InitStruct.Pin = DAT_Pin|L2_Pin;
  ...
  /*Configure GPIO pins : R1_Pin L1_Pin */
